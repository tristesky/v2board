    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #e5e7eb;">
        ...
        <tr>
            <td style="padding:34px 36px 14px 36px;">
                <div style="font-size:26px;font-weight:700;line-height:1.4;color:#111827;">服务即将到期</div>
                <div style="font-size:16px;line-height:1.8;color:#4b5563;margin-top:16px;">尊敬的用户您好，您的服务将在 <span style="color:#dc2626;font-size:22px;font-weight:700;">24 小时内</span> 到期。</div>
            </td>
        </tr>
        <tr>
            <td style="padding:0 36px 28px 36px;font-size:16px;line-height:1.8;color:#4b5563;">
                为避免服务中断，请您尽快完成续费。如果您已经续费，可以放心忽略这封邮件。
            </td>
        </tr>
        <tr>
            <td style="padding:0 36px 36px 36px;">
                <a href="{{$url}}" style="display:inline-block;background:#315493;color:#ffffff;text-decoration:none;font-size:16px;font-weight:700;border-radius:6px;padding:12px 22px;">前往续费</a>
            </td>
        </tr>
        <tr>
